...
def get_dataset(params, configs):
    ...
    if 'mnist' in params['dataset']:
        ...
        train_loader_2 = torch.utils.data.DataLoader(train_dst, batch_size=params['batch_size_2'], shuffle=True,
                                                   num_workers=4)
        ...
        val_loader_2 = torch.utils.data.DataLoader(val_dst, batch_size=100, shuffle=True, num_workers=4)
        return train_loader, train_dst, val_loader, val_dst, train_loader_2,val_loader_2
